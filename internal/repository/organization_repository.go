...
type OrganizationRepository interface {
	...
	FindByUnitCode(unitCode string) (*model.Organization, error)
	FindAll() ([]model.Organization, error)
	FindByParentID(parentID *string) ([]model.Organization, error)
	FindByUnitType(unitType string) ([]model.Organization, error)
	BuildOrganizationTree(orgs []model.Organization) []model.Organization
	CheckUnitCodeExists(unitCode string, excludeID string) (bool, error)
	IsDescendant(ancestorID, targetID string) (bool, error)
}
