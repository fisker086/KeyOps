...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_fisker086_keyops_internal_model.Budget"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_fisker086_keyops_internal_model.Policy"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_fisker086_keyops_internal_model.Pool"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/bill/resources/resource-count-breakdown": {
            "get": {
    ...
    "definitions": {
        ...
        "github_com_fisker086_keyops_internal_model.BillPrice": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": "规格，如 1:2, 1:4 (对应scale)",
                    "type": "string"
                },
                "unit": {
                    "description": "单位：GB, Hour",
                    "type": "string"
                },
                "unit_price": {
                    "description": "单价 (对应price)",
                    "type": "number"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "github_com_fisker086_keyops_internal_model.Budget": {
            "type": "object",
            "properties": {
                "alert_channel_ids": {
                    "description": "JSON数组：[1,2,3]",
                    "type": "string"
                },
                "alert_threshold": {
                    "description": "告警阈值百分比",
        ...
        "github_com_fisker086_keyops_internal_model.Policy": {
            "type": "object",
            "properties": {
                "action": {
                    "description": "stop/terminate/tag",
                    "type": "string"
                },
                "conditions": {
                    "description": "JSON条件",
        ...
        "github_com_fisker086_keyops_internal_model.Pool": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
